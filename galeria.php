...
<html lang="pl-PL">
    <head>
        ...
        <meta name="description" content="Efekty pracy firmy Sylterm z Polic, zajmującej się instalacjami c.o. i wodno-kanalizacyjnymi">
...
<?php
    ...
    $fotki = glob(GALERIA_DIR.'*.{jpg,JPG,png,PNG}',GLOB_BRACE); //uwaga, sortowane najpierw według kolejności masek
